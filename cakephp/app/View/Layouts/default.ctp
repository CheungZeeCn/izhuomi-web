                      ...
                      <li class="dropdown" id="menuLogin">
                        <?php if(isset($_username)){?> 
                            ...
                            <ul class="dropdown-menu" style="padding:2px;left:auto;right:0;">
                                <li><a href="<?php echo $this->Html->url("/dashboard", true); ?>">设置个人信息(todo)</a></li>
                        ...
                        <?php } else { ?>
                            ...
                            <div class="dropdown-menu" style="padding:20px;left:auto;right:0;width:250px">
                                <?php echo $this->Form->create('User', array('id' => 'topBarLogin', 'url'=>'/login?redirect2='.urlencode($this->Html->url(null, true)), 'data-ajax' => 'false')); ?>
                                    <fieldset>
                                        <?php 
